...
class RankingsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create ranking" do
    assert_difference('Ranking.count') do
      post rankings_url, params: { ranking: { category: @ranking.category, elements: @ranking.elements, name: @ranking.name } }
    end
  ...
  test "should update ranking" do
    patch ranking_url(@ranking), params: { ranking: { category: @ranking.category, elements: @ranking.elements, name: @ranking.name } }
